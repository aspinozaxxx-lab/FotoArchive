...
try {
    ...
    foreach ($document in @('VALIDATION.md', 'VALIDATION-v064.md', 'VALIDATION-v070.md', 'VALIDATION-v071.md', 'VALIDATION-v072.md', 'VALIDATION-v080.md', 'CATALOG-v070.md', 'README.md', 'requirements.lock')) {
